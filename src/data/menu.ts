...
export const menuItems: MenuItem[] = [
  {
    ...
    name: "كينج سموكي",
    description:
      "قطع دجاج متبلة، صوص باربيكيو مدخن، ميكس جبن، خضار",
    price: 130,
    image: "",
    available: true,
  },
  ...
  },
  {
    ...
    name: "التشيكو فاهيتا",
    description:
      "شرائح دجاج فاهيتا متبلة، بصل وفلفل ملون، تتبيلة مكسيكية",
    price: 135,
    image: "",
    available: true,
  },
  ...
  },
  {
    ...
    name: "بلو ويف",
    description:
      "قطع دجاج، صوص الجبنة الريكفورد المميزة، وموزاريلا",
    price: 140,
    image: "",
    available: true,
  },
  {
    ...
    name: "تشيكن مونستر",
    description:
      "ميكس دجاج مقرمش ومشوي، حشو مضاعف، وموزاريلا",
    price: 140,
    image: "",
    available: true,
  },

  {
    ...
    name: "ميكس الحاتي",
    description:
      "توليفة شرقية مميزة من الكفتة والسجق البلدي مع الموزاريلا",
    price: 140,
    image: "",
    available: true,
  },
  {
    ...
    description:
      "شرائح هوت دوج مكسيكانو، صوص تشيلي حار، موزاريلا، جبنة تركي",
    price: 140,
    image: "",
    available: true,
  },
  {
    ...
    name: "حدوقة ميكس جبن",
    description:
      "توليفة مميزة من الجبن الشيدر والموزاريلا والتركي السايح",
    price: 110,
    image: "",
    available: true,
  },

  {
    ...
    description:
      "جمبري مقلي كرانشي، سبيط مقرمش، طحينة، وموزاريلا",
    price: 210,
    image: "",
    available: true,
  },
  {
    ...
    description:
      "ميكس جمبري وسبيط مشوي بالزبدة والثوم والليمون، وموزاريلا",
    price: 210,
    image: "",
    available: true,
  },
...

  {
    ...
    name: "جولدن ستريبس",
    description:
      "قطع دجاج إستريبس مقرمشة ذهبية، خس، ومايونيز",
    priceOptions: [
      { label: "M", price: 100 },
      { label: "L", price: 130 },
    ],
  ...
  {
    id: "blue-wave-sandwich",
    category: "chicken-sandwiches",
    name: "بلو ويف",
    description: "قطع دجاج، صوص الجبنة الريكفورد المميزة",
    priceOptions: [
      { label: "M", price: 100 },
      { label: "L", price: 130 },
    ],
  ...
  {
    id: "sonic-bomb-sandwich",
    category: "chicken-sandwiches",
    name: "سونيك بوم",
    description:
      "دجاج زنجر مقرمش سبايسي، صوص حار، وهالبينو",
    priceOptions: [
      { label: "M", price: 110 },
      { label: "L", price: 140 },
    ],
  ...
  },
  {
    ...
    category: "chicken-sandwiches",
    name: "فاير شوت",
    description: "قطع دجاج مشعلة بصوص الفاير الحار المميز",
    priceOptions: [
      { label: "M", price: 100 },
      { label: "L", price: 130 },
    ],
  ...
  },
  {
    ...
    category: "chicken-sandwiches",
    name: "شيش بوب",
    description: "شيش طاووق متبل وممشوي على الجريل مع الخضار",
    priceOptions: [
      { label: "M", price: 100 },
      { label: "L", price: 130 },
    ],
  ...
  },
  {
    ...
    name: "بافلو بوم",
    description:
      "قطع دجاج مقرمشة بصوص البافلو الأمريكي الحامض واللاذع",
    priceOptions: [
      { label: "M", price: 100 },
      { label: "L", price: 130 },
    ],
  ...
  },
  {
    ...
    name: "فاهيتا كلاس",
    description:
      "شرائح دجاج فاهيتا متبلة على الجريل مع البصل والفلفل الملون",
    priceOptions: [
      { label: "M", price: 100 },
      { label: "L", price: 130 },
    ],
...

  {
    ...
    name: "تشيكن هيل",
    description: "برجر دجاج، خس، مايونيز، وصوصات مميزة",
    priceOptions: [
  ...
  },
  {
    ...
    name: "بافلو ستريبس",
    description:
      "قطع دجاج إستريبس مقرمشة بصوص البافلو الحار",
    priceOptions: [
      { label: "سنجل", price: 120 },
      { label: "دبل", price: 150 },
    ],
  ...
  },
  {
    ...
    name: "مستر صاور",
    description:
      "برجر دجاج بخلطة الصوص الحامض المميز والمخلل",
    priceOptions: [
      { label: "سنجل", price: 120 },
      { label: "دبل", price: 150 },
    ],
...

  {
    ...
    name: "تشيزي ليزي",
    description:
      "برجر لحم مشوي غرقان بصوص الجبنة الشيدر السايحة",
    priceOptions: [
  ...
  },
  {
    ...
    description:
      "ساندوتش برجر لحم كلاسيكي + بطاطس مقرمشة + بيبسي كولا",
    price: 150,
    image: "",
    available: true,
  },
  {
    ...
    category: "beef-burger",
    name: "كاوبوي",
    description: "برجر لحم، بيف بيكون مدخن، وصوص باربيكيو",
    priceOptions: [
      { label: "سنجل", price: 150 },
      { label: "دبل", price: 210 },
    ],
  ...
  },
  {
    ...
    name: "مشروم لافا",
    description:
      "برجر لحم، مشروم مشوي، غرقان بصوص المشروم والشيدر",
    priceOptions: [
      { label: "سنجل", price: 150 },
      { label: "دبل", price: 210 },
    ],
...

  {
    ...
    name: "سماش تاون",
    description:
      "لحم بقري مضغوط مقرمش، جبنة شيدر، خيار مخلل، وصوص السماش",
    priceOptions: [
      { label: "سنجل", price: 150 },
      { label: "دبل", price: 210 },
    ],
  ...
  },
  {
    ...
    category: "smash-burger",
    name: "سماش هانتر",
    description: "لحم سماش مميز، صوصات غنية، وخضار فريش",
    priceOptions: [
      { label: "سنجل", price: 150 },
      { label: "دبل", price: 210 },
    ],
  ...
  },
  {
    ...
    name: "سموكي مشروم",
    description:
      "لحم سماش، مشروم مشوي، بيف بيكون مدخن، وجبنة شيدر",
    priceOptions: [
      { label: "سنجل", price: 150 },
      { label: "دبل", price: 210 },
    ],
  ...
  },
  {
    ...
    name: "زفير",
    description:
      "جمبري مشوي، فلفل ألوان، بصل مكرمل، بهارات مكسيكية، صوص مميز",
    priceOptions: [
      { label: "M", price: 150 },
      { label: "L", price: 210 },
    ],
  ...
  },
  {
    ...
    name: "بلبع",
    description:
      "سندوتش الملوك: ميكس جمبري وسبيط مقلي أو مشوي، صوص ديناميت، جرجير",
    priceOptions: [
      { label: "M", price: 150 },
      { label: "L", price: 210 },
    ],
  ...
  },
  {
    ...
    name: "جولدن شرمب",
    description:
      "جمبري ذهبي مقرمش، صوص المطعم، مايونيز، ليمون، خيار مخلل",
    priceOptions: [
      { label: "M", price: 150 },
      { label: "L", price: 210 },
    ],
  ...
  },
  {
    ...
    name: "اللول",
    description:
      "ميكس سي فود غرقان صوص جبنة سايحة وبهارات المطعم المميزة",
    priceOptions: [
      { label: "M", price: 150 },
      { label: "L", price: 210 },
    ],
...

  {
    ...
    name: "نيجرسكو لافا",
    description:
      "قطع دجاج ومشروم فريش، غرقانة ببركان من صوص البشاميل والموزاريلا السايحة",
    priceOptions: [
      { label: "S", price: 140 },
      { label: "M", price: 180 },
      { label: "L", price: 220 },
  ...
  },
  {
    ...
    name: "كرانشي وايت",
    description:
      "باستا كريمي بالوايت صوص، مغطاة بقطع الدجاج المقرمشة الذهبية الكرانشي",
    priceOptions: [
      { label: "S", price: 160 },
      { label: "M", price: 200 },
      { label: "L", price: 240 },
  ...
  },
  {
    ...
    name: "وايت لافا",
    description:
      "بركان الصوص الأبيض الكريمي الغني الغرقان بميكس أجبان دسمة وموزاريلا",
    priceOptions: [
      { label: "S", price: 180 },
      { label: "M", price: 240 },
      { label: "L", price: 300 },
  ...
  },
  {
    ...
    name: "سيسليا",
    description:
      "طعم صقلية الأصيل: باستا بالريد صوص المتبل بالأعشاب مع ميكس لحوم مميز",
    priceOptions: [
      { label: "S", price: 200 },
      { label: "M", price: 250 },
      { label: "L", price: 300 },
  ...
  },
  {
    ...
    name: "فينيسيا",
    description:
      "باستا فينيسيا الساحرة بصوص ميكس (بينك صوص) يجمع بين كريمية الوايت صوص وقوة الريد صوص",
    priceOptions: [
      { label: "S", price: 200 },
      { label: "M", price: 250 },
      { label: "L", price: 300 },
  ...
  },
  {
    ...
    name: "روما لحوم",
    description:
      "باستا العاصمة روما: قطع لحم ستيك دايبة ومشروم مشوي بالصوص البني الفاخر",
    priceOptions: [
      { label: "S", price: 150 },
      { label: "M", price: 200 },
      { label: "L", price: 250 },
  ...
  },
  {
    ...
    name: "بولونيز لحوم",
    description:
      "الباستا الإيطالية الكلاسيكية باللحم المفروم المتبل وصلصة الطماطم الغنية",
    priceOptions: [
      { label: "S", price: 150 },
      { label: "M", price: 200 },
      { label: "L", price: 250 },
  ...
  },
  {
    ...
    name: "توسكاني",
    description:
      "وصفة إقليم توسكانا الشهيرة بقطع اللحم المتبل والبهارات الخاصة مع الصوص الغني",
    priceOptions: [
      { label: "S", price: 150 },
      { label: "M", price: 200 },
      { label: "L", price: 250 },
...

  {
    ...
    name: "شيتوس بوتيتو",
    description:
      "أصابع بطاطس، صوص الجبنة الشيدر السايحة، وفتات شيتوس المقرمش",
    priceOptions: [
      { label: "باكت", price: 45 },
